...
@Component
@ConditionalOnProperty(prefix = "ferrum.ui", name = "type", havingValue = "console")
public class ConsoleRunner implements FerrumUi {
    ...
    public void run(String... args) {
        ...
        while (true) {
            ...
            System.out.printf("%nBuscando %s\"%s\"%s en Metal Archives...%n%n",
    ...
    private void printBanner() {
        System.out.println(BOLD + RED + """
                ...
                """ + RESET);
        System.out.println(DIM + "  Ferrum — Scraper de consola para Metal Archives" + RESET);
        System.out.println();
    }
}
